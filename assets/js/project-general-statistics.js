$(document).ready(function () {
  $("#multiple-checkboxes-regions").multiselect({
    includeSelectAllOption: true,
    numberDisplayed: 0,
    nonSelectedText: "Continents & regions",
  });
  $("#multiple-checkboxes-beneficiary").multiselect({
    includeSelectAllOption: true,
    numberDisplayed: 0,
    nonSelectedText: "Beneficiary Countries",
  });
  ...
  $("#multiple-checkboxes-regions-mobile").multiselect({
    inheritClass: true,
    includeSelectAllOption: true,
    numberDisplayed: 0,
    nonSelectedText: "Continents & regions",
  ...
  $("#btn-mobile-filter-apply").click(function () {
    let filterHtml = "";
    const filterSelectors = [
      $("#multiple-checkboxes-regions-mobile"),
